...
class LSTMEncoder(nn.Module):
    def __init__(self, embedding_size, hidden_size, num_layers, bidirectional=False):
    ...
    def forward(self, inp, inp_lengths):
        packed_input = nn.utils.rnn.pack_padded_sequence(inp, inp_lengths, batch_first=True, enforce_sorted=False)
